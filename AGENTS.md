...
- `packages/rolldown/src/binding.cjs` - Based on `crates/rolldown_binding`, auto-generated by `just build-rolldown`
- `packages/rolldown/src/binding.d.cts` - Based on `crates/rolldown_binding`, auto-generated by `just build-rolldown`
