...
- `packages/rolldown/dist/binding.cjs` - Based on `crates/rolldown_binding`, auto-generated by `just build-rolldown`
- `packages/rolldown/dist/binding.d.cts` - Based on `crates/rolldown_binding`, auto-generated by `just build-rolldown`
