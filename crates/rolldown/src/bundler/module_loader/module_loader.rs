...
use rolldown_common::{
  EntryPoint, EntryPointKind, FilePath, ImportKind, ImportRecordId, ModuleId, NormalModuleId,
  ResourceId,
};
...
use crate::bundler::types::module_table::{ExternalModuleVec, ModuleTable};
