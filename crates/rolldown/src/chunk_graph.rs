...
use rolldown_common::{Chunk, ChunkIdx, EcmaModuleIdx};
...
pub struct ChunkGraph {
  ...
  pub module_to_chunk: IndexVec<EcmaModuleIdx, Option<ChunkIdx>>,
  pub entry_module_to_entry_chunk: FxHashMap<EcmaModuleIdx, ChunkIdx>,
}
