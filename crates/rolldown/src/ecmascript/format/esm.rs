...
pub fn render_esm<'code>(
  ...
  super::share_factory::append_share_prologue(ctx, &mut source_joiner);
...
pub fn render_chunk_content<'code>(
  ctx: &GenerateContext<'_>,
...
pub fn render_esm_chunk_imports(ctx: &GenerateContext<'_>) -> Option<String> {
