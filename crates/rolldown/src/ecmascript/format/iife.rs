...
use crate::utils::chunk::render_chunk_exports::{get_export_items, render_chunk_exports};
...
pub fn render_iife(
  ...
  let (factory, caller) = render_iife_factory(ctx, &export_mode, has_exports, &externals)?;
