                ...
                if let Some(import_decl) = top_stmt.as_import_declaration() {
                    ...
                    *top_stmt.span_mut() = default_decl_span;
                    ...
                    if let Statement::ClassDeclaration(class_decl) = &mut top_stmt {
                        ...
                        let class_id = self.snippet.builder.binding_pattern(BindingPatternKind::BindingIdentifier(
                            self.snippet.builder.alloc(class_name)
                        ), NONE, false);
                        ...
                        let decl = self.snippet.builder.alloc_variable_declaration(SPAN, VariableDeclarationKind::Var, self.snippet.builder.vec1(
