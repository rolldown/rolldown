...
pub struct LinkingMetadata {
  ...
  /// wrapper body. Only a direct-eval module needs it. There, nested `exports` bindings keep their
  /// source name, and one of them captures the bare `exports` that a top-level `this` emits.
