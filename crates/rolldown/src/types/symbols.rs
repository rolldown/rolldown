...
use rolldown_common::{ChunkId, EcmaModuleId, SymbolRef};
...
pub struct Symbols {
  inner: IndexVec<EcmaModuleId, IndexVec<SymbolId, Symbol>>,
}
...
impl Symbols {
  ...
  pub fn add_ast_symbols(&mut self, module_id: EcmaModuleId, ast_symbols: AstSymbols) {
  ...
  pub fn create_symbol(&mut self, owner: EcmaModuleId, name: CompactString) -> SymbolRef {
    let symbol_id =
