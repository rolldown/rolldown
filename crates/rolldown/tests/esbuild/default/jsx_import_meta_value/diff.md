...
```js
//#region factory.jsx
console.log([/* @__PURE__ */ import.meta("x", null), /* @__PURE__ */ {}("x", null)]);
f = function() {
	console.log([/* @__PURE__ */ import.meta("y", null), /* @__PURE__ */ {}("y", null)]);
};
...
+console.log([import.meta("x", null), ({})("x", null)]);
 f = function () {
-    console.log([import_meta("y", null), import_meta("y", null)]);
+    console.log([import.meta("y", null), ({})("y", null)]);
 };
...
```js
//#region fragment.jsx
console.log([/* @__PURE__ */ import.meta(import.meta, null, "x"), /* @__PURE__ */ {}({}, null, "x")]), f = function() {
	console.log([/* @__PURE__ */ import.meta(import.meta, null, "y"), /* @__PURE__ */ {}({}, null, "y")]);
};
...
+(console.log([import.meta(import.meta, null, "x"), ({})({}, null, "x")]), f = function () {
+    console.log([import.meta(import.meta, null, "y"), ({})({}, null, "y")]);
 });
