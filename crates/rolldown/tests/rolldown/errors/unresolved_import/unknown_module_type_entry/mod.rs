...
#[derive(Debug)]
struct UnknownModuleTypeEntry;

impl Plugin for UnknownModuleTypeEntry {
  fn name(&self) -> Cow<'static, str> {
    "unresolved-import-unknown-module-type-entry".into()
  }
    ...
    .run_with_plugins(
      BundlerOptions {
        input: Some(vec![InputItem {
          ...
          import: "./entry.javascript".to_string(),
        }]),
        cwd: Some(cwd),
        ..Default::default()
      },
      vec![Arc::new(UnknownModuleTypeEntry)],
    )
    .await;
}
