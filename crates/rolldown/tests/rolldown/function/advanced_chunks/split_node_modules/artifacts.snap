...
```js
import { __esm, init_lib_ui, lib_ui_exports } from "./ui.js";
...
```js
import { __esm, __export } from "./ui.js";
...
var __export = (target, all) => {
	for (var name in all) __defProp(target, name, typeof all[name] === "function" ? {
		get: all[name],
		enumerable: true
	} : {
		value: all[name],
...
//#endregion
export { __esm, __export, init_lib_ui, lib_ui_exports };
```
