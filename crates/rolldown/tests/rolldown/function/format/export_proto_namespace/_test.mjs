...
if (configName === 'esm') {
  ...
  assert.strictEqual(
    Object.hasOwn(esm.lib, '__proto__'),
    true,
    'ESM: lib.__proto__ should be an own property',
  );
  ...
  assert.strictEqual(
    Object.hasOwn(cjs.lib, '__proto__'),
    true,
    'CJS: lib.__proto__ should be an own property',
  );
  ...
  assert.strictEqual(
    Object.hasOwn(iife.lib, '__proto__'),
    true,
    'IIFE: lib.__proto__ should be an own property',
  );
  ...
  assert.strictEqual(
    Object.hasOwn(umd.lib, '__proto__'),
    true,
    'UMD: lib.__proto__ should be an own property',
  );
