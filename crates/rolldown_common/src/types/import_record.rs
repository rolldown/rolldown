...
impl RawImportRecord {
  ...
  pub fn into_resolved(self, resolved_module: ModuleIdx) -> ResolvedImportRecord {
    ...
    // more details about `is_dummy` please refer: https://github.com/rolldown/rolldown/blob/1c8352a6d0fc79f737f160cefe2eaedb476047ca/crates/rolldown_common/src/ecmascript/module_idx.rs?plain=1#L6-L8
