...
pub struct ClientSession {
  ...
  /// Written ONLY by the delivery notification (`DevEngine::notify_payload_delivered`,
  /// after the client ran the payload), never at render or push. `ArcStr` keys share the
