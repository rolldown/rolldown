...
#[derive(Debug)]
pub struct AmbiguousReexportModule {
  pub source: ArcStr,
...
pub struct AmbiguousReexport {
  ...
  pub importee: String,
  pub importer: AmbiguousReexportModule,
  pub exporter: Vec<AmbiguousReexportModule>,
}

impl BuildEvent for AmbiguousReexport {
  fn kind(&self) -> EventKind {
    EventKind::AmbiguousReexportError
  }
