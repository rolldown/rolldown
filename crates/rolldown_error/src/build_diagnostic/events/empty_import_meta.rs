...
pub enum EmptyImportMetaKind {
  ...
  Url,
  /// Generated by expanding an `import.meta.ROLLUP_FILE_URL_*` reference into
...
impl BuildEvent for EmptyImportMeta {
  ...
  fn on_diagnostic(&self, diagnostic: &mut Diagnostic, opts: &DiagnosticOptions) {
    ...
    if matches!(self.kind, EmptyImportMetaKind::RollupFileUrl) {
      diagnostic.add_label(
        &file_id,
        self.span.start..self.span.end,
        String::from(
          "This `import.meta.ROLLUP_FILE_URL_*` is rewritten to `new URL(..., import.meta.url).href`, and that generated `import.meta.url` becomes `undefined`.",
        ),
      );
