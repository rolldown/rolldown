...
You can use the generated JSON with various visualization tools:

1. **Custom HTML Viewer**: See `chunk-visualizer.html` in the root
2. **CLI Analyzer**: Run `node analyze-chunks.mjs dist/analyze-data.json --stats`
3. **CI/CD Integration**: Use `node ci-bundle-check.mjs dist/analyze-data.json`
...
```
✓ 3 chunks built in 123ms

Output:
  dist/main-a1b2c3.js         45.2 KB
  dist/chunks/admin-d4e5f6.js 34.5 KB
  dist/chunks/vendor-g7h8i9.js 123.4 KB
  dist/analyze-data.json      12.3 KB
```
...
- [Chunk Visualization Format](../../CHUNK_VISUALIZATION.md)
- [Bundle Optimization Guide](https://rolldown.rs/guide/optimization)
