...
| `PackageGraphReady`          | After chunk graph construction            | packages[]{package_id, name, version, package_json_path, package_root, is_used, dependency_type, modules[], chunk_ids[]} |
