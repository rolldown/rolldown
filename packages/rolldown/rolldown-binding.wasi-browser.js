...
function __napi_rs_initialize_modules(__napiInstance) {
  __napiInstance.exports[
    '__napi_register__IsolatedDeclarationsResult_struct_0'
  ]?.()
  __napiInstance.exports['__napi_register__isolated_declaration_1']?.()
  __napiInstance.exports[
    '__napi_register__TypeScriptBindingOptions_struct_2'
  ]?.()
  __napiInstance.exports['__napi_register__ReactBindingOptions_struct_3']?.()
  __napiInstance.exports[
    '__napi_register__ArrowFunctionsBindingOptions_struct_4'
  ]?.()
  ...
  __napiInstance.exports[
    '__napi_register__BindingPluginContextResolvedId_struct_18'
  ]?.()
  __napiInstance.exports['__napi_register__BindingPluginOptions_struct_19']?.()
  __napiInstance.exports[
    '__napi_register__BindingPluginWithIndex_struct_20'
  ]?.()
  __napiInstance.exports[
    '__napi_register__BindingTransformPluginContext_struct_21'
  ]?.()
  __napiInstance.exports[
    '__napi_register__BindingTransformPluginContext_impl_23'
  ]?.()
  ...
  __napiInstance.exports[
    '__napi_register__BindingHookRenderChunkOutput_struct_27'
  ]?.()
  __napiInstance.exports[
    '__napi_register__BindingHookResolveIdExtraOptions_struct_28'
  ]?.()
  __napiInstance.exports[
    '__napi_register__BindingHookResolveIdOutput_struct_29'
  ]?.()
  __napiInstance.exports['__napi_register__BindingHookSideEffects_30']?.()
  __napiInstance.exports[
    '__napi_register__BindingHookTransformOutput_struct_31'
  ]?.()
  __napiInstance.exports[
    '__napi_register__BindingPluginContextResolveOptions_struct_32'
  ]?.()
  ...
  __napiInstance.exports[
    '__napi_register__ParallelJsPluginRegistry_struct_35'
  ]?.()
  __napiInstance.exports[
    '__napi_register__ParallelJsPluginRegistry_impl_37'
  ]?.()
