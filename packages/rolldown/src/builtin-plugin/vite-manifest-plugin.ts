...
export type ViteManifestPluginConfig = Omit<BindingViteManifestPluginConfig, 'isLegacy'> & {
  isOutputOptionsForLegacyChunks?: (outputOptions: NormalizedOutputOptions) => boolean;
};

export function viteManifestPlugin(config: ViteManifestPluginConfig): BuiltinPlugin {
