...
type hookFilterExtension<K extends keyof FunctionPluginHooks> = 
  K extends 'transform' ? { filter?: BaseHookFilter } : 
  K extends 'load' ? { filter?: Omit<BaseHookFilter, 'code' | 'moduleType'> } :  
  K extends 'resolveId' ? { filter?: Omit<BaseHookFilter, 'code' | 'moduleType'> } : {}
...
export type PluginHooks = {
  [K in keyof FunctionPluginHooks]: ObjectHook<
    (K extends AsyncPluginHooks
      ...
      : FunctionPluginHooks[K]) & hookFilterExtension<K>
