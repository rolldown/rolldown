...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingLog_struct_40']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_41']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_42']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_44']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_45']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_50']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_51']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_69']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_70']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_74']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_struct_75']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_impl_78']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_79']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_80']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_81']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_82']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_83']?.()
}
