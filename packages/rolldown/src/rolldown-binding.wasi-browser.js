...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingGeneralHookFilter_struct_42']?.()
  __napiInstance.exports['__napi_register__BindingTransformHookFilter_struct_43']?.()
  __napiInstance.exports['__napi_register__BindingHookLoadOutput_struct_44']?.()
  __napiInstance.exports['__napi_register__BindingHookRenderChunkOutput_struct_45']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdExtraArgs_struct_46']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdOutput_struct_47']?.()
  __napiInstance.exports['__napi_register__BindingHookSideEffects_48']?.()
  __napiInstance.exports['__napi_register__BindingHookTransformOutput_struct_49']?.()
  __napiInstance.exports['__napi_register__BindingPluginContextResolveOptions_struct_50']?.()
  __napiInstance.exports['__napi_register__BindingTransformHookExtraArgs_struct_51']?.()
  __napiInstance.exports['__napi_register__BindingBuiltinPlugin_struct_52']?.()
  __napiInstance.exports['__napi_register__BindingGlobImportPluginConfig_struct_53']?.()
  __napiInstance.exports['__napi_register__BindingManifestPluginConfig_struct_54']?.()
  __napiInstance.exports['__napi_register__BindingModulePreloadPolyfillPluginConfig_struct_55']?.()
  __napiInstance.exports['__napi_register__BindingJsonPluginConfig_struct_56']?.()
  __napiInstance.exports['__napi_register__BindingJsonPluginStringify_struct_57']?.()
