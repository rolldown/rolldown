...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingPluginContext_impl_26']?.()
  __napiInstance.exports['__napi_register__BindingPluginContextResolvedId_struct_27']?.()
  __napiInstance.exports['__napi_register__BindingPluginOptions_struct_28']?.()
  __napiInstance.exports['__napi_register__BindingPluginWithIndex_struct_29']?.()
  __napiInstance.exports['__napi_register__BindingTransformPluginContext_struct_30']?.()
  __napiInstance.exports['__napi_register__BindingTransformPluginContext_impl_32']?.()
  __napiInstance.exports['__napi_register__BindingAssetSource_struct_33']?.()
  __napiInstance.exports['__napi_register__BindingEmittedAsset_struct_34']?.()
  __napiInstance.exports['__napi_register__BindingGeneralHookFilter_struct_35']?.()
  __napiInstance.exports['__napi_register__BindingTransformHookFilter_struct_36']?.()
  __napiInstance.exports['__napi_register__BindingHookLoadOutput_struct_37']?.()
  __napiInstance.exports['__napi_register__BindingHookRenderChunkOutput_struct_38']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdExtraArgs_struct_39']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdOutput_struct_40']?.()
  __napiInstance.exports['__napi_register__BindingHookSideEffects_41']?.()
  __napiInstance.exports['__napi_register__BindingHookTransformOutput_struct_42']?.()
  __napiInstance.exports['__napi_register__BindingStringOrRegex_struct_43']?.()
