...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingWatcher_struct_158']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_161']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_struct_162']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_impl_168']?.()
  __napiInstance.exports['__napi_register__BindingWatcherChangeData_struct_169']?.()
  __napiInstance.exports['__napi_register__BindingBundleEndEventData_struct_170']?.()
}
