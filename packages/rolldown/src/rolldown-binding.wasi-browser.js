...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingAliasPluginConfig_struct_43']?.()
  __napiInstance.exports['__napi_register__BindingAliasPluginAlias_struct_44']?.()
  __napiInstance.exports['__napi_register__BindingPluginOrder_45']?.()
  __napiInstance.exports['__napi_register__BindingPluginHookMeta_struct_46']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_47']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_49']?.()
  __napiInstance.exports['__napi_register__register_plugins_50']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_51']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_52']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_53']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_55']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_56']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_61']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_62']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_80']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_81']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_85']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_struct_86']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_impl_89']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_90']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_91']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_92']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_93']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_94']?.()
}
