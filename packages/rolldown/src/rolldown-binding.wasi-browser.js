...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingHookJsResolveIdOutput_struct_68']?.()
  __napiInstance.exports['__napi_register__BindingHookJsLoadOutput_struct_69']?.()
  __napiInstance.exports['__napi_register__BindingPluginOrder_70']?.()
  __napiInstance.exports['__napi_register__BindingPluginHookMeta_struct_71']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_72']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_74']?.()
  __napiInstance.exports['__napi_register__register_plugins_75']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_76']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_77']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_78']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_80']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_81']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_86']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_87']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_88']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_103']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_104']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_105']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_108']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_109']?.()
  __napiInstance.exports['__napi_register__PreRenderedChunk_struct_110']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_111']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_112']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_113']?.()
  __napiInstance.exports['__napi_register__ExtensionAliasItem_struct_114']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_115']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_116']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_struct_117']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_120']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_121']?.()
}
