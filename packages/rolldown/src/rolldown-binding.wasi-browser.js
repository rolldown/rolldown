...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingCallableBuiltinPlugin_impl_65']?.()
  __napiInstance.exports['__napi_register__BindingHookResolveIdReturn_struct_66']?.()
  __napiInstance.exports['__napi_register__BindingPluginOrder_67']?.()
  __napiInstance.exports['__napi_register__BindingPluginHookMeta_struct_68']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_69']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_71']?.()
  __napiInstance.exports['__napi_register__register_plugins_72']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_73']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_74']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_75']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_77']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_78']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_83']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_84']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_85']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_100']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_101']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_102']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_105']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_106']?.()
  __napiInstance.exports['__napi_register__PreRenderedChunk_struct_107']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_108']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_109']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_110']?.()
  __napiInstance.exports['__napi_register__ExtensionAliasItem_struct_111']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_112']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_113']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_struct_114']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_117']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_118']?.()
}
