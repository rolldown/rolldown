...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingPluginOrder_47']?.()
  __napiInstance.exports['__napi_register__BindingPluginHookMeta_struct_48']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_49']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_51']?.()
  __napiInstance.exports['__napi_register__register_plugins_52']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_53']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_54']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_55']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_57']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_58']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_64']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_65']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_83']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_84']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_88']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_struct_89']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_impl_92']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_93']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_94']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_95']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_96']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_97']?.()
}
