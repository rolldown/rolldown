...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingNormalizedInputOptions_impl_86']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_87']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_92']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_93']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_94']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_109']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_110']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_111']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_115']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_116']?.()
  __napiInstance.exports['__napi_register__PreRenderedChunk_struct_117']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_118']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_119']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_impl_121']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_122']?.()
  __napiInstance.exports['__napi_register__ExtensionAliasItem_struct_123']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_124']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_125']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_struct_126']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_129']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_struct_130']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_impl_136']?.()
  __napiInstance.exports['__napi_register__BindingWatcherChangeData_struct_137']?.()
  __napiInstance.exports['__napi_register__BindingBundleEndEventData_struct_138']?.()
}
