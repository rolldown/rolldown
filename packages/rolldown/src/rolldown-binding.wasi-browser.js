...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingNormalizedOptions_impl_91']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_92']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_97']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_98']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_99']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_114']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_115']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_116']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_120']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_121']?.()
  __napiInstance.exports['__napi_register__PreRenderedChunk_struct_122']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_123']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_124']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_impl_126']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_127']?.()
  __napiInstance.exports['__napi_register__ExtensionAliasItem_struct_128']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_129']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_130']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_struct_131']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_134']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_struct_135']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_impl_141']?.()
  __napiInstance.exports['__napi_register__BindingWatcherChangeData_struct_142']?.()
  __napiInstance.exports['__napi_register__BindingBundleEndEventData_struct_143']?.()
}
