...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingViteResolvePluginConfig_struct_58']?.()
  __napiInstance.exports['__napi_register__BindingViteResolvePluginResolveOptions_struct_59']?.()
  __napiInstance.exports['__napi_register__BindingReplacePluginConfig_struct_60']?.()
  __napiInstance.exports['__napi_register__is_callable_compatible_builtin_plugin_61']?.()
  __napiInstance.exports['__napi_register__BindingCallableBuiltinPlugin_struct_62']?.()
  __napiInstance.exports['__napi_register__BindingCallableBuiltinPlugin_impl_66']?.()
  __napiInstance.exports['__napi_register__BindingHookJsResolveIdOutput_struct_67']?.()
  __napiInstance.exports['__napi_register__BindingHookJsLoadOutput_struct_68']?.()
  __napiInstance.exports['__napi_register__BindingPluginOrder_69']?.()
  __napiInstance.exports['__napi_register__BindingPluginHookMeta_struct_70']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_71']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_73']?.()
  __napiInstance.exports['__napi_register__register_plugins_74']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_75']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_76']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_77']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_79']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_80']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_85']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_86']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_87']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_102']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_103']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_104']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_107']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_108']?.()
  __napiInstance.exports['__napi_register__PreRenderedChunk_struct_109']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_110']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_111']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_112']?.()
  __napiInstance.exports['__napi_register__ExtensionAliasItem_struct_113']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_114']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_115']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_struct_116']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_119']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_120']?.()
}
