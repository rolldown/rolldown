...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_83']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_88']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_89']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_90']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_105']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_106']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_107']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_110']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_111']?.()
  __napiInstance.exports['__napi_register__PreRenderedChunk_struct_112']?.()
  __napiInstance.exports['__napi_register__RenderedChunk_struct_113']?.()
  __napiInstance.exports['__napi_register__BindingRenderedModule_struct_114']?.()
  __napiInstance.exports['__napi_register__AliasItem_struct_115']?.()
  __napiInstance.exports['__napi_register__ExtensionAliasItem_struct_116']?.()
  __napiInstance.exports['__napi_register__BindingSourcemap_struct_117']?.()
  __napiInstance.exports['__napi_register__BindingJsonSourcemap_struct_118']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_struct_119']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_122']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_123']?.()
}
