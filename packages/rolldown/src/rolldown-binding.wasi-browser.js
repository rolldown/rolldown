...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingPluginOrder_61']?.()
  __napiInstance.exports['__napi_register__BindingPluginHookMeta_struct_62']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_63']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_65']?.()
  __napiInstance.exports['__napi_register__register_plugins_66']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_67']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_68']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_69']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_71']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_72']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_77']?.()
  __napiInstance.exports['__napi_register__JsOutputAsset_struct_78']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_79']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_94']?.()
  __napiInstance.exports['__napi_register__JsOutputChunk_struct_95']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_96']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_99']?.()
  __napiInstance.exports['__napi_register__JsChangedOutputs_struct_100']?.()
  ...
  __napiInstance.exports['__napi_register__BindingWatcher_struct_108']?.()
  __napiInstance.exports['__napi_register__BindingWatcher_impl_111']?.()
  __napiInstance.exports['__napi_register__BindingWatcherEvent_112']?.()
}
