...
function __napi_rs_initialize_modules(__napiInstance) {
  ...
  __napiInstance.exports['__napi_register__BindingTransformHookExtra_struct_33']?.()
  ...
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_struct_39']?.()
  __napiInstance.exports['__napi_register__ParallelJsPluginRegistry_impl_41']?.()
  __napiInstance.exports['__napi_register__register_plugins_42']?.()
  __napiInstance.exports['__napi_register__BindingLog_struct_43']?.()
  __napiInstance.exports['__napi_register__BindingLogLevel_44']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_struct_45']?.()
  __napiInstance.exports['__napi_register__BindingModuleInfo_impl_47']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_struct_48']?.()
  __napiInstance.exports['__napi_register__BindingOutputAsset_impl_53']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_struct_54']?.()
  __napiInstance.exports['__napi_register__BindingOutputChunk_impl_72']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_struct_73']?.()
  __napiInstance.exports['__napi_register__BindingOutputs_impl_77']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_struct_78']?.()
  __napiInstance.exports['__napi_register__FinalBindingOutputs_impl_81']?.()
