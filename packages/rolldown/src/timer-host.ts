...
const reserveCurrentThreadHostRegistration: unknown = binding.reserveCurrentThreadHostRegistration;
...
if (!completeHostContract || typeof getCurrentThreadTaskHostContractVersion !== 'function') {
...
try {
  ...
  if (hostInstallation && !import.meta.browserBuild) {
