...
import {
  ...
  caseInsensitiveNegatedModules,
  caseSensitiveModules,
} from './dist/main';
...
assert.strictEqual(caseInsensitiveNegatedModules['./dir/data-test.js'], 'data-test');
assert.strictEqual(caseInsensitiveNegatedModules['./dir/DATA-other.js'], undefined);
