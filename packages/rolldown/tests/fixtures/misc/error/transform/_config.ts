...
export default defineTest({
  ...
  // round-trip on the WASI binding (stack frames, custom props, the
  // `[plugin my-plugin]` diagnostic prefix and the PLUGIN_ERROR code are
  // lost). See fixtures/misc/error/load/_config.ts.
  skip: isWasiTest,
  config: {
    plugins: [
      {
