...
const SKIP_TESTS = [
  ...
  // (regex + string replacement in the Rust binding; function replacers on the JS side in
  // binding-magic-string.ts; 'rejects with non-global regexp' passes via the wrapper's
  // real TypeError)
