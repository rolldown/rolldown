...
import {
  getRadiusStyle,
  radiusControls,
} from 'https://framerusercontent.com/modules/N6MwtHbWoiZJNn1xpqxu/58OHv7BfCzgeBhiv1TYu/radius.js';
import {
  getPaddingStyle,
  paddingControls,
} from 'https://framerusercontent.com/modules/wjZLfSMaP1TvJDu5PCwr/6SPClu354QJPCp6Xj5C0/padding.js';
import {
  getHoverStyle,
  hoverControls,
...
function Icon({ type, color, image, size }) {
  if (type === 'custom' && image) {
    return /*#__PURE__*/ _jsx('img', { ...image, width: size, height: size });
  }
...
const LocaleSelector = withCSS(
  (
    ...
    var _activeLocale_id;
    const activeLocaleId =
      (_activeLocale_id = activeLocale === null || activeLocale === void 0
            ? void 0
            : activeLocale.id) !== null && _activeLocale_id !== void 0
        ? _activeLocale_id
        : 'default';
    const [lastActiveLocaleId, setLastActiveLocaleId] = useState(
      activeLocaleId,
        ...
        /*#__PURE__*/ _jsxs('div', {
          ...
          children: [
            ...
            title && /*#__PURE__*/ _jsx('div', {
              className: 'title',
              children:
                (_selectedLocale_name =
                      selectedLocale === null || selectedLocale === void 0
                        ? void 0
                        : selectedLocale.name) !== null &&
                  _selectedLocale_name !== void 0
                  ? _selectedLocale_name
                  : 'English',
            }),
            caret && /*#__PURE__*/
...
addPropertyControls(LocaleSelector, {
  ...
  textColor: { type: ControlType.Color, title: 'Text', defaultValue: '#000' },
  ...paddingControls,
  ...radiusControls,
  icon: {
  ...
  options: {
    ...
    controls: {
      title: { type: ControlType.Boolean, defaultValue: true },
      gap: { type: ControlType.Number, displayStepper: true, defaultValue: 5 },
      border: {
        type: ControlType.Object,
