...
} from 'https://framerusercontent.com/modules/tV9haTHllpHHc9Fjue2H/Xy775u0FJg3K1GQc1Cd9/SearchModal.js';
...
const EntryPoint = withCSS(function EntryPoint(props) {
  ...
  const theme = {
    ...
    titleFont: ((_props_resultOptions = props.resultOptions) === null ||
    ...
    inputFont: ((_props_inputOptions1 = props.inputOptions) === null ||
  ...
  const handleClick = event => { // Both need to keep `autofocus` working on the search input.
