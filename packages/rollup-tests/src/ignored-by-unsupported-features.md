...
- rollup@form@cjs-transpiler-re-exports-1: Disable reexporting the **proto** from the external module if both output.externalLiveBindings and output.reExportProtoFromExternal are false@generates cjs
