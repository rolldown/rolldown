...
runTestSuiteWithSamples(
	...
	(directory, config) => {
        ...
        if (content.includes('// removed') || content.includes(`console.log('removed')`) || content.includes('const unused = ') || config.description.includes('Tree-shake') || config.description.includes('tree-shake') || directory.includes('tree-shake') || directory.includes('treeshakes') || directory.includes('side-effect') || config.description.includes('side-effect') || content.includes('/*#__NO_SIDE_EFFECTS__*/') || directory.includes('skips-dead-branches') 
