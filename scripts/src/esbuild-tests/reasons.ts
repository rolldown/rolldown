...
export const failedReasons: Record<string, string> = {
  ...
  'default/comment_preservation_transform_jsx': 'comments are not kept properly',
...
export const notSupportedReasons: Record<string, string> = {
  'default/mangle_props_jsx_transform_namespace': 'mangle props is not supported by oxc minifier',
  'default/mangle_props_type_script_features': 'mangle props is not supported by oxc minifier',
  ...
  'default/minify_nested_labels_no_bundle': 'label mangling is not supported by oxc minifier',

  'ts/export_type_issue379': 'verbatimModuleSyntax=false is not supported',

  'default/legal_comments_avoid_slash_tag_end_of_file': 'escaping </style> in CSS is not supported',
  ...
  'default/legal_comments_avoid_slash_tag_inline': 'escaping </style> in CSS is not supported',
  'default/legal_comments_end_of_file': "`legalComments: 'eof'` is not supported",
  ...
  'default/legal_comments_escape_slash_script_and_style_external':
    "`legalComments: 'external'` is not supported. escaping </style> in CSS is not supported",
  'default/legal_comments_external': "`legalComments: 'external'` is not supported",
  'default/legal_comments_linked': "`legalComments: 'linked'` is not supported",
  'default/legal_comments_many_end_of_file': "`legalComments: 'eof'` is not supported",
  'default/legal_comments_many_linked': "`legalComments: 'linked'` is not supported",
  ...
  'loader/loader_copy_with_injected_file_bundle': 'copy loader is not supported',
  ...
  'loader/extensionless_loader_css': 'extension less moduleTypes is not supported',
  ...
  'loader/loader_file_public_path_asset_names_js': 'publicPath equivalent option is not supported',
  'loader/loader_file_public_path_asset_names_css': 'publicPath equivalent option is not supported',

  'loader/loader_file_relative_path_asset_names_css': 'bug?: file reference URL difference',
  'loader/loader_file_relative_path_asset_names_js': 'bug?: file reference URL difference',
  ...
  'default/comment_preservation_import_assertions': 'import attributes is not supported',
  'default/metafile_import_with_type_json': 'import attributes is not supported',
  'default/output_for_assert_type_json': 'import attributes is not supported',
  'loader/loader_bundle_with_import_attributes': 'import attributes is not supported',
  ...
  'default/require_shim_substitution': 'require second argument is not supported',

  'dce/dead_code_inside_unused_cases': 'dce inside unused switch cases is not supported',

  'default/import_with_hash_parameter': 'stripping hash parameter is not supported',
  'default/import_with_query_parameter': 'stripping query parameter is not supported',
  'loader/loader_file_with_query_parameter': 'stripping query parameter is not supported',
  'loader/loader_from_extension_with_query_parameter': 'stripping query parameter is not supported',
};

export const ignoreReasons: Record<string, string> = {
  'default/import_abs_path_as_dir': 'limitation of test infra, the test may hard to pass in CI',
  'default/import_abs_path_as_file': 'limitation of test infra, the test may hard to pass in CI',
  ...
  'default/error_message_crash_stdin_issue2913': 'irrelevant: stdin input is not supported',
