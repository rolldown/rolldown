...
// Packages embedded in dist/fs.js of @napi-rs/wasm-runtime 1.2.3 and 1.2.4.
const wasmRuntime12FsPackages = [
  '@jsonjoy.com/base64',
  '@jsonjoy.com/buffers',
  '@jsonjoy.com/fs-core',
  '@jsonjoy.com/fs-node',
...
const auditedRuntimeFsBundles = new Map([
  [
    ...
    { version: '1.2.3', packages: wasmRuntime12FsPackages },
  ],
  [
    // dist/fs.js of @napi-rs/wasm-runtime 1.2.4 (2026-09-10). Upstream delta
    // from 1.2.3 (tags @napi-rs/wasm-runtime@1.2.3...@1.2.4): one formatting
    // change in wasm-runtime/fs-proxy.js (#3501) and a tsdown bump; the
    // region-marker derivation above yields the same 47 packages, and memfs
    // stays listed for the same reason, so the inventory is unchanged.
    '0d4b8c98dea82828883a29c6dd07b31b7d1d0f23ae7854ebc464a0d3a3d9cedf',
    { version: '1.2.4', packages: wasmRuntime12FsPackages },
  ],
]);
